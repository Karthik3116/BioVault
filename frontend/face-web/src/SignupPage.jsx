...
//   // Manage camera for face capture
//   useEffect(() => {
//     let stream;
//     if (cameraOn) {
...
//   // Convert Blob → FormData-compatible file
...
//             Capture 3–5 face samples. Click to turn camera on.
//           </p>
...
//               </>
//             ) : (
//               <button onClick={() => setCameraOn(true)} className="text-gray-400">
//                 <Camera size={48} />
//                 <p>Turn Camera On</p>
//               </button>
//             )}
...
//             >
//               <Camera /> Capture ({snapshots.length})
//             </button>
//             <button
